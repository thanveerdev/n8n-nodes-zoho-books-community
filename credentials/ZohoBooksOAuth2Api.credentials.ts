...
export class ZohoBooksOAuth2Api implements ICredentialType {
	...
	properties: INodeProperties[] = [
		...
		},
		{
			...
			description:
				'Use sandbox when your Zoho Books account is set up in the sandbox environment'
		},
		{
			displayName: 'Scope',
			name: 'scope',
		...
		},
		{
			...
			type: 'hidden',
			default:
				'={{"https://accounts.zoho." + $self.dataCenter + "/oauth/v2/auth"}}',
		...
		},
		{
			...
			type: 'hidden',
			default:
				'={{"https://accounts.zoho." + $self.dataCenter + "/oauth/v2/token"}}',
		...
		},
		{
			...
			type: 'hidden',
			default:
				'={{"https://sandbox.zohoapis." + $self.dataCenter + "/books/v3"}}',
